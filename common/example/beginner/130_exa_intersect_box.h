...
tnl::Vector2f sizeA = { 50, 50 };

tnl::Vector2f posB = { 600, 400 };
tnl::Vector2f sizeB = { 200, 40 };
...
void gameMain(float delta_time) {
	...
	// 移動前の座標を覚えておく
	tnl::Vector2f before_A = posA;
	tnl::Vector2f before_B = posB;
	...
	DrawFormatString(posA.x - 7, posA.y - 15, -1, "A");
	DrawFormatString(posB.x - 7, posB.y - 15, -1, "B");
