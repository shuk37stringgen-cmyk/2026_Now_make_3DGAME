...
//
//
// カプセル( 移動している球体 )と OBB の衝突判定と補正サンプル
//
//
//-----------------------------------------------------------------------------------------------------------
...
void gameMain(float delta_time) {
	...
	float t = 0;
	if (tnl::IsIntersectCapsuleOBB(cap_st, cap_en, cap_r, box_pos, box_size, box_rot, &t)) {
	...
	dxe::DrawOBB(camera, box_pos, box_size, box_rot, dxe::Colors::Red);
